                    ...
                    if (
                        ...
                        !1 === result &&
                            ...
                            (result = (function (pos, c, strict) {
                                ...
                                for (
                                    prevAltPos =
                                        getMaskSet().validPositions[lAltPos];
                                    lAltPos >= 0;
                                    lAltPos--
                                )
                                    if (
                        ...
                        function importAttributeOptions(
                            ...
                            if (!0 === opts.importDataAttributes) {
                                var option,
                                    ...
                                    attrOptions =
                                        npt.getAttribute(dataAttribute);
                                if (
                                    (attrOptions &&
                                        "" !== attrOptions &&
                                ...
                                switch (m.charAt(0)) {
                                    ...
                                    case opts.alternatormarker:
                                        ...
                                        if (lastMatch.isAlternator)
                                            ...
                                            (alternatorGroup.alternatorGroup =
                                                !0),
                                                openenings.push(
                                                    alternatorGroup
                                                );
                        ...
                        regex: {
                            ...
                            val2pre: function (separator) {
                                var escapedSeparator =
                                    Inputmask.escapeRegex.call(this, separator);
                                return new RegExp(
                                    "((0[1-9]|[12][0-9]|3[01])" +
                                        escapedSeparator +
                                        "[01])"
            ...
            return (
                ...
                Inputmask.extendAliases({
                    ...
                    email: {
                        ...
                        onBeforePaste: function (pastedValue, opts) {
                            return (pastedValue =
                                pastedValue.toLowerCase()).replace(
                                "mailto:",
                                ""
                            );
                        },
