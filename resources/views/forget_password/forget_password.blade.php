                        ...
                        <div class="card card-custom">
                            <div class="card-body">
                                <div class="login-signin">
                                    ...
                                    <form class="form" id="kt_login_signin_form" method="POST" action="{{ url('admin/forget_password') }}">
                                        @csrf
                                        <div class="form-group mb-5">
                                            <input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Email" name="email" autocomplete="off" required="required"/>
                                        </div>
