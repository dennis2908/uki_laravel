            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ url('admin/tipster/transaction/create') }}" class="btn btn-primary font-weight-bolder">
...
@section('script')
    <script>
        async function openTableTransaction(id){
            ...
            await $('#table thead tr').append("<th>Type</th>");
            await $('#table thead tr').append("<th>Bet Type</th>");
            ...
            $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/tipster/transaction/datatable') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "idMatchBet" : id
                ...
                columns: [
                    ...
                    {data: 'bet_type', className: "text-center"},
        ...
        $(document).ready(function(){
            $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/tipster/transaction/dataMatchBet') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}"
                    }
